 ...
 */
function owlpress_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function owlpress_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function owlpress_sanitize_html( $html ) {
 ...
 */
function owlpress_sanitize_image( $image, $setting ) {
 ...
 */
function owlpress_sanitize_nohtml( $nohtml ) {
 ...
 */
function owlpress_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function owlpress_sanitize_range_value( $number, $setting ) {
 ...
 */
function owlpress_sanitize_select( $input, $setting ) {
 ...
 */
function owlpress_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function owlpress_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function owlpress_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
